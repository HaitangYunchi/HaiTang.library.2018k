...
namespace HaiTang.Library.Api2018k.Bilibili
{
    ...
    public class BilibiliCookieService : IDisposable
    {
        ...
        public BilibiliCookieService(string cookieFilePath = "cookies.dat", DeviceInfo deviceInfo = null)
        {
            ...
            _deviceInfo = deviceInfo ?? new DeviceInfo(); // 使用默认设备信息
            ...
            _httpClient.DefaultRequestHeaders.Add("X-App-Version", _deviceInfo.AppVersion);
        ...
        public async Task<bool> ValidateCookiesAsync(CookieData cookies)
        {
            ...
            try
            {
                ...
                client.DefaultRequestHeaders.Add("User-Agent", _deviceInfo.GetFullUserAgent());

                // 修改：添加设备信息头
                client.DefaultRequestHeaders.Add("X-Device-Id", _deviceInfo.DeviceId);
                client.DefaultRequestHeaders.Add("X-Device-Name", _deviceInfo.DeviceName);
